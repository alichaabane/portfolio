const content = {
    ...
    header: {
        ...
        text: ['Hi!', "It's me Ali Chaabane.", 'I am '],
        typical: [
            'Software Developer. 🖥',
            2000,
            'Frontend Developer 🖥',
    ...
    stack: {
        ...
        desc: `MERN is one of several variations of the MEAN stack (MongoDB Express Angular Node), where the traditional Angular.js frontend framework is replaced with React.js. Other variants include MEVN (MongoDB, Express, Vue, Node), and really any frontend JavaScript framework can work.
`
    },
    ...
    project: {
        ...
        projectName: 'Meetup',
        desc: 'Getting Started with Meetup App (my first react project) ',
        website: 'https://meetups-project-86e41.web.app/'
    },
